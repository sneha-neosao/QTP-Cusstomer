        ...
        new Handler().postDelayed(new Runnable(){
            ...
            public void run() {
                ...
                if(!preferences.getBoolean("onboarding_complete",false))
                {
                    ...
                    Intent intent1 =new Intent(SplashActivity.this,MainDrawerActivity.class);
...
// Check for the integer request code originally supplied to startResolutionForResult().
    ...
    public void ShowLoginAlerts(String message) {
        ...
        SweetAlertDialog alertDialog = new SweetAlertDialog(SplashActivity.this, SweetAlertDialog.WARNING_TYPE);
