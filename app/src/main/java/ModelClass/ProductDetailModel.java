...
public class ProductDetailModel
{
    ...
    private String itemID,unitID,itemName,shortDes,uomId,uom,itemSellingprice,mainSupplier,vatRate,
            adminRating, image,discount,fixedPrice,stockingType,customerRating,ratingUserCount,
            productLabel,categoryID, itemSubCategory;
