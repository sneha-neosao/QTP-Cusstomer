...
public class RecommendationInSearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecommendationInSearchAdapter(Context context, List<NewCartModel> topSelling, RecyclerView recyclerView1) {
...
//                        MainDrawerActivity.bottomNavigation.setCount(4, dbcart.getWishlistCount());
    ...
    private void updateMultiply(int pos, int i)
    {
        try {
            ...
            map.put("price", String.valueOf(topSelling.get(pos).getItemSellingprice()));
