...
public class CartAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public CartAdapter(Context context, List<NewCartModel> topSelling,RecyclerView recyclerView1,List<LabelModel> labelModels) {
...
//        springyAdapterAnimator.addConfig(85,15);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_ITEM) {
            view = LayoutInflater.from(context).inflate(R.layout.layout_product_add_new, parent, false);
...
//            springyAdapterAnimator.onSpringItemCreate(view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (viewHolder instanceof MyViewHolder) {
            ...
            NewCartModel cc = topSelling.get(viewHolder.getAdapterPosition());
            //all
            ...
            Log.e("stock","stock cart:"+cc.getStockingType());
            if (cc.getStockingType().equals("Non Stock")){
            ...
            holder.constraintLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("itemID", cc.getProduct_id()); //key and value
            ...
            if(cc.getProduct_image()!=null){
                Picasso.get()
                        ...
                        .placeholder(R.drawable.noimageavailable).into(holder.image);
            ...
            int qtyd = Integer.parseInt(dbcart.getInCartItemQtys(topSelling.get(viewHolder.getAdapterPosition()).getProduct_id()));
            if (qtyd > 0) {
            ...
            holder.minus.setOnClickListener(v -> {
                Log.i("Product _id", topSelling.get(viewHolder.getAdapterPosition()).getProduct_id());
                int i = Integer.parseInt(dbcart.getInCartItemQtys(topSelling.get(viewHolder.getAdapterPosition()).getProduct_id()));
                ...
                updateMultiply(viewHolder.getAdapterPosition(), (i - 1));
            });
            ...
            holder.image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (session_management.isLoggedIn()) {
                        ...
                        api.addToRecent(topSelling.get(viewHolder.getAdapterPosition()).getProduct_id());
                    }
                    if (holder.cartCount.getText().toString().equals("+")) {

                        holder.cartCount.setVisibility(View.VISIBLE);
                        holder.cartCount.setText("x1");
                        updateMultiply(viewHolder.getAdapterPosition(), 1);
    ...
    {
        try {
            Log.i("Product_id", topSelling.get(pos).getProduct_id());
            Log.d("supplier_id",""+ topSelling.get(pos).getSupplierID());
            HashMap<String, String> map = new HashMap<>();
            map.put("varient_id", topSelling.get(pos).getUnitID());
            ...
            map.put("status", "");
            map.put("stock",topSelling.get(pos).getStockingType());
            ...
            map.put("ItemId", topSelling.get(pos).getProduct_id());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ImageView img_info1;
        TextView txt_info;
        LinearLayout txt_info1,img_info;
    ...
    public void addToCart(HashMap<String, String> map,int qty,String action)
    {
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                Log.d("CheckApiCart add",params.toString());
                Log.d("CheckApiCart add",map.toString());
                try {
