...
public class BannerAdapter1 extends RecyclerView.Adapter<BannerAdapter1.BannerImage> {
    ...
    public BannerAdapter1(Context context, ArrayList<String> images, ArrayList<HashMap<String, String>> listarray) {
    ...
    public BannerImage onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.image_layout_1, parent, false);
