...
public class AcceptedOrderFragment extends Fragment implements OrderCancelListner, GetOrderAdaper1.OnRetryOrderClickListener, GetOrderAdaper1.OnRetryPaymentClickListener {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ApiBaseURL.OrderList, response -> {
            ...
            try {
                ...
                else if(!status)
                {
                    ...
                    noData.setVisibility(View.VISIBLE);
                    assign_recy.setVisibility(View.GONE);
                  //  OrderFragment.tabLayout.setBadgeText(2,"0");
                    progressDialog.dismiss();
                }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Log.e("paramAccept",params.toString());
                return params;
            }
        };
