...
public class PendingOrderFragment extends Fragment implements OrderCancelListner, GetOrderAdaper1.OnRetryOrderClickListener, GetOrderAdaper1.OnRetryPaymentClickListener {
...
*/
                    /*if(listorl.size()>0)
                    OrderFragment.tabLayout.setBadgeText(1, String.valueOf(listorl.size()));
                    else
                    OrderFragment.tabLayout.setBadgeText(1, "0");*/
...
//                }
    ...
    private void showDialogForRetryPayment(int position, ArrayList<NewGetOrderModel> newGetOrderModelArrayList) {
        ...
        btn_orderConfirm_yes.setOnClickListener(view -> {
...
//            }
        ...
        btn_orderConfirm_no.setOnClickListener(view -> dialog.dismiss());
