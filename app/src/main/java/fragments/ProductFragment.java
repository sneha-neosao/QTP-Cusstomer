...
public class ProductFragment extends Fragment implements SubOfSubCategoryAdapter.ItemOnClickListener{
    ...
    private ArrayList<ResponseGetAllSubOfSubCategories.AllSubOfSubCategories> subOfSubCategoriesList = new ArrayList<>();
...
//    SpringyAdapterAnimator springyAdapterAnimator;
    LinearLayout ll_sort,llTab;
    ProgressDialog progressDialog;
    String subCategoryId="",categoryId="";

    RecyclerView rvSubOfSubCat;
    
    String subCategoryId1="",subOfSubCategoryId="All",filter1="";
    ImageView ivAll;

    SubOfSubCategoryAdapter subOfSubCategoryAdapter;
...
//    }
    public static ProductFragment getInstance(ProductSector sector) {
        ...
        ProductFragment tabFragment = new ProductFragment();
    ...
    /*<androidx.recyclerview.widget.RecyclerView
        ...
        android:id="@+id/rvSubOfSubCat"
        app:layoutManager="androidx.recyclerview.widget.LinearLayoutManager"
        android:orientation="horizontal"
        android:layout_gravity="center"
        tools:listitem="@layout/item_sub_cat_tab"/>*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvSubOfSubCat = view.findViewById(R.id.rvSubOfSubCat);
...
//        });
       ...
       /* ivAll.setVisibility(View.VISIBLE);
        ...
        if(!GetCategories.getSubOfSubCategoriesBySubCategory(cat_id).isEmpty()) {
            ...
            llTab.setVisibility(View.VISIBLE);
            subOfSubCategoriesList = GetCategories.getSubOfSubCategoriesBySubCategory(cat_id);
            subOfSubCategoryAdapter.setList(subOfSubCategoriesList);
        }else{
            subOfSubCategoriesList.clear();
            rvSubOfSubCat.setVisibility(View.GONE);
        ...
        ivAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getProductsBySubofSubcategory(cat_id,"All","");
                subOfSubCategoryAdapter.changeTextColorAndBackground(tvPosition,false);
                //ivAll.setBackgroundColor(getActivity().getResources().getColor(R.color.colorPrimary));
                ivAll.setBackgroundTintList(ColorStateList.valueOf(getActivity().getResources().getColor(R.color.aqua)));
                ivAll.setImageTintList(ColorStateList.valueOf(getActivity().getResources().getColor(R.color.white)));
            }
        });

        recycler_product.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
...
//                        }
    ...
    private void showFullScreenDialog(String bannerImage,String bannerId){
        ...
        Picasso.get().load(ApiBaseURL.IMG_URL +bannerImage).error(R.mipmap.ic_launcher).into(ivPopUp);
        dialog.show();
        ...
        btnShopNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                Intent intent = new Intent(getContext(), BannerItemsActivity.class);
                    ...
                    if (status) {
                       ...
                       /* JSONObject jsonObjectPopUp = response.getJSONObject("popup");
                        if(jsonObjectPopUp.has("banner_image")&&!jsonObjectPopUp.getString("banner_image").isEmpty()){
                            showFullScreenDialog(jsonObjectPopUp.getString("banner_image"),jsonObjectPopUp.getString("banner_id"));
                        }*/
...
//                        }
    ...
    public void onItemClick(int position, ArrayList<ResponseGetAllSubOfSubCategories.AllSubOfSubCategories> items) {
        tvPosition=position;
        subOfSubCategoryAdapter.changeTextColorAndBackground(tvPosition,true);
        //ivAll.setBackgroundColor(getActivity().getResources().getColor(R.color.lighter_greys));
        ivAll.setBackgroundTintList(ColorStateList.valueOf(getActivity().getResources().getColor(R.color.lighter_greys)));
        ivAll.setImageTintList(ColorStateList.valueOf(getActivity().getResources().getColor(R.color.colorPrimary)));
        subCategoryId1 =items.get(position).getSubOfSubCategoryId();
        subOfSubCategoryId=items.get(position).getItem_subCatID();
        filter1="";
        getProductsBySubofSubcategory(items.get(position).getSubOfSubCategoryId(),items.get(position).getItem_subCatID(),filter1);
    }
}
